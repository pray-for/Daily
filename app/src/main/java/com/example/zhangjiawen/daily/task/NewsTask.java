...
/**
 * Created by zhangjiawen on 2017/5/26.
 */
public class NewsTask extends AsyncTask<String , Void  , NewsEntity> {
    ...
    public NewsTask(ImageView imageView , TextView textView_title , TextView images_source ,
                    WebView webView , boolean isNightMode){
